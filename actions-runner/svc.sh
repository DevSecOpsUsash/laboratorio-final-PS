...
SVC_NAME="actions.runner.DevSecOpsUsash-laboratorio-final-PS.MacBook-Pro-de-Pablo"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (DevSecOpsUsash-laboratorio-final-PS.MacBook-Pro-de-Pablo)"
